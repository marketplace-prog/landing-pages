...
//#endregion
//#region app/components/dia-do-cliente.ce.vue?vue&type=script&setup=true&lang.ts
var eo = { class: "min-h-screen bg-background text-foreground" }, to = {
	id: "categorias",
	class: "mx-auto max-w-7xl px-5 py-20 lg:px-10"
}, no = { class: "grid grid-cols-2 gap-3 md:grid-cols-4" }, ro = ["href"], io = { class: "font-sans text-2xl font-black uppercase tracking-[-0.06em] text-primary-foreground" }, ao = {
	id: "colecao",
	class: "bg-secondary px-5 py-20 lg:px-10"
}, oo = { class: "mx-auto max-w-7xl" }, so = { class: "grid gap-5 md:grid-cols-3" }, co = ["id"], lo = { class: "relative aspect-4/5 overflow-hidden bg-muted" }, uo = ["src", "alt"], fo = { class: "absolute left-4 top-4 flex gap-2" }, po = { class: "bg-accent px-2 py-1 font-mono text-[9px] font-bold uppercase text-accent-foreground" }, mo = ["aria-label"], ho = { class: "flex items-start justify-between gap-4 py-4" }, go = { class: "font-sans text-lg font-bold uppercase" }, _o = { class: "mt-1 font-mono text-[10px] uppercase tracking-[0.12em] text-muted-foreground" }, vo = { class: "font-mono text-xs" }, yo = /* @__PURE__ */ Wa(/* @__PURE__ */ ((e, t) => {
	let n = e.__vccOpts || e;
	...
	setup(e) {
		...
		return (e, r) => (bi(), Ti("main", eo, [
			...
			Y("section", to, [r[1] ||= Y("div", { class: "mb-10 flex items-end justify-between" }, [Y("div", null, [Y("p", { class: "font-mono text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground" }, " Expanda seu portfólio "), Y("h2", { class: "mt-3 font-sans text-4xl font-black uppercase tracking-tighter" }, "Modalidades")]), Y("a", {
				href: "#colecao",
				class: "hidden font-mono text-[10px] font-bold uppercase tracking-[0.15em] underline underline-offset-4 sm:block"
			}, " Ver linhas completas ")], -1), Y("div", no, [(bi(), Ti(q, null, ir(t, (e) => Y("a", {
				href: e.url,
				class: "group relative flex min-h-48 items-end overflow-hidden bg-primary p-5"
			}, [Y("span", io, k(e.label), 1), r[0] ||= Y("svg", {
				...
				"aria-hidden": "true"
			}, [Y("path", { d: "M7 7h10v10" }), Y("path", { d: "M7 17 17 7" })], -1)], 8, ro)), 64))])]),
			Y("section", ao, [Y("div", oo, [r[4] ||= Y("div", { class: "mb-10 flex items-end justify-between" }, [Y("div", null, [Y("p", { class: "font-mono text-[10px] font-bold uppercase tracking-[0.2em] text-muted-foreground" }, " Giro Rápido "), Y("h2", { class: "mt-3 font-sans text-4xl font-black uppercase tracking-tighter text-secondary-foreground" }, " Mais Vendidos B2B ")]), Y("a", {
				href: "#newsletter",
				class: "font-mono text-[10px] font-bold uppercase tracking-[0.15em] text-secondary-foreground underline underline-offset-4"
			}, " Ver tabela de preços ")], -1), Y("div", so, [(bi(), Ti(q, null, ir(n, (e) => Y("article", {
				id: e.label,
				class: "group"
			}, [Y("div", lo, [
				Y("img", {
				...
				Y("div", fo, [Y("span", po, k(e.highlightText), 1)]),
				Y("button", {
					...
					"aria-hidden": "true"
				}, [Y("path", { d: "M2 9.5a5.5 5.5 0 0 1 9.591-3.676.56.56 0 0 0 .818 0A5.49 5.49 0 0 1 22 9.5c0 2.29-1.5 4-3 5.5l-5.492 5.313a2 2 0 0 1-3 .019L5 15c-1.5-1.5-3-3.2-3-5.5" })], -1)]], 8, mo),
			...
			]), Y("div", ho, [Y("div", null, [Y("h3", go, k(e.label), 1), Y("p", _o, k(e.category), 1)]), Y("strong", vo, " A partir de " + k(e.price.toLocaleString("pt-BR", {
				currency: "BRL",
				style: "currency"
			})), 1)])], 8, co)), 64))])])]),
